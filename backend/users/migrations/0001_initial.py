    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('mushoheh', 'Mushoheh'), ('katib', 'Katib'), ('reader', 'Reader')], default='reader', max_length=20)),
                ('bio', models.TextField(blank=True)),
                ('institution', models.CharField(blank=True, max_length=255)),
                ('expertise', models.JSONField(default=list)),
                ('profile_image', models.CharField(blank=True, max_length=1024)),
            ...
            options={
                'indexes': [models.Index(fields=['role'], name='users_user_role_idx'), models.Index(fields=['username'], name='users_user_username_idx'), models.Index(fields=['email'], name='users_user_email_idx')],
            },
            managers=[
